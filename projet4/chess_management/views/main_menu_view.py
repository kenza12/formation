...
class MainMenuView:
    ...
    def initialize_view(self) -> None:
        ...
        tk.Button(
            ...
            command=self.controller.user_manager.display_player_submenu,
        ).pack()
        tk.Button(
            self.root,
            text="Tournament management",
            command=self.controller.tournament_manager.display_tournament_submenu,
        ).pack()
        tk.Button(
            self.root,
            text="Start a tournament",
            command=self.controller.tournament_manager.start_tournament,
        ).pack()
        ...
        tk.Button(
            self.root,
            text="View reports",
            command=self.controller.tournament_manager.display_reports_submenu,
        ).pack()
    ...
    def load_tournament_from_file(self) -> None:
        ...
        file_path = filedialog.askopenfilename(
            title="Sélectionnez le fichier du tournoi",
